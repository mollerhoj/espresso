...
(function() {
  var $, AppData, Art, Board, Button, CameraMan, Collision, EditorData, Entity, EntityButton, EntityMenu, Explosion, Fireball, Game, GameMenu, Grid, Hero, Keyboard, LevelData, LevelEditor, LevelPrinter, Menu, ParentEntityMenu, Settings, Skull, SpriteImage, Toolbox, World, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
  ...
  Menu = (function(_super) {
    ...
    Menu.prototype.step = function() {
      var button, h_jump, _i, _len, _ref1, _results;
      if (!this.active) {
        return;
      }
      this.h = 0;
    ...
    Menu.prototype.button_press = function(button_clicked) {
      var button, _i, _len, _ref1, _results;
  ...
  GameMenu = (function(_super) {
    ...
    GameMenu.prototype.load = function(tree) {
      var b, key, value, _ref4, _results;
      this.clear_buttons();
      this.current = tree;
      _ref4 = this.current.buttons;
      _results = [];
      for (key in _ref4) {
        value = _ref4[key];
        b = new Button;
  ...
  ParentEntityMenu = (function(_super) {
    ...
    function ParentEntityMenu() {
      _ref6 = ParentEntityMenu.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
    ...
    ParentEntityMenu.prototype.step = function() {
      var button, _i, _len, _ref7, _results;
      if (!this.active) {
        return;
      }
      this.h = 0;
  ...
  EntityMenu = (function(_super) {
    ...
    function EntityMenu() {
      var b, key, space_between_buttons, value, _ref7;
      EntityMenu.__super__.constructor.apply(this, arguments);
      space_between_buttons = 2;
      _ref7 = AppData.entities;
      for (key in _ref7) {
        value = _ref7[key];
        b = new EntityButton;
        b.text = key;
  ...
  Toolbox = (function() {
    ...
    Toolbox.deactivate = function() {
      var tool, _i, _j, _len, _len1, _ref7, _ref8;
      Toolbox._active = false;
      _ref7 = Toolbox.tools_always;
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        tool = _ref7[_i];
        tool.active = false;
      }
      _ref8 = Toolbox.tools_editor;
    ...
    Toolbox.menuOn = function() {
      var tool, _i, _j, _len, _len1, _ref7, _ref8, _results;
      Toolbox._menu = true;
      _ref7 = Toolbox.tools_menu;
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        tool = _ref7[_i];
        tool.active = true;
      }
    ...
    Toolbox.step = function() {
      var tool, _i, _j, _k, _len, _len1, _len2, _ref7, _ref8, _ref9, _results;
      if (Keyboard.press('L')) {
      ...
      _ref8 = Toolbox.tools_menu;
      for (_j = 0, _len1 = _ref8.length; _j < _len1; _j++) {
        tool = _ref8[_j];
        tool.step();
      }
      _ref9 = Toolbox.tools_editor;
      _results = [];
  ...
  EntityButton = (function(_super) {
    ...
    EntityButton.prototype.select = function() {
      var listener, _i, _len, _ref7, _results;
      this._selected = true;
      _ref7 = this._listeners;
      _results = [];
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        listener = _ref7[_i];
        _results.push(listener.button_press(this));
  ...
  LevelPrinter = (function() {
    ...
    LevelPrinter.get_board = function() {
      var board, cell_height, cell_width, e, subboard, _i, _len, _ref7;
      cell_width = Settings.grid.cell_width;
      cell_height = Settings.grid.cell_height;
      board = [];
      _ref7 = World.all_entities();
      for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
        e = _ref7[_i];
    ...
    LevelPrinter.print = function() {
      var e, i, newline, o, txt, _i, _len, _ref7;
      i = 1;
      txt = '';
      newline = "&#10;";
