...
(function() {
  var $, AppData, Apple, Art, Builder, Collision, Editor, Entity, Game, GameController, Grid, ImageLoader, Keyboard, Level, Snake, SnakeBody, SnakeBodyShadow, Sprite, Text, World,
  ...
  GameController = (function(_super) {
    ...
    GameController.prototype.init = function() {
      ...
      this.world.spawn('Snake', 100, 100);
      return this.world.spawn('Apple', 100, 100);
    };
  ...
  SnakeBody = (function(_super) {
    ...
    function SnakeBody() {
      return SnakeBody.__super__.constructor.apply(this, arguments);
    }

    SnakeBody.prototype.time = 0;

    SnakeBody.prototype.solid = false;

    SnakeBody.prototype.e = null;

    SnakeBody.prototype.z = 1;

    SnakeBody.prototype.init = function() {
      return this.e = this.world.spawn('SnakeBodyShadow', this.x, this.y);
    };

    SnakeBody.prototype.destroy = function() {
      this.e.destroy();
      return SnakeBody.__super__.destroy.call(this);
    };

    SnakeBody.prototype.step = function() {
      this.time += 1;
      if (this.time > 10) {
        this.solid = true;
      }
  ...
  SnakeBodyShadow = (function(_super) {

    __extends(SnakeBodyShadow, _super);

    function SnakeBodyShadow() {
      return SnakeBodyShadow.__super__.constructor.apply(this, arguments);
    }

    SnakeBodyShadow.prototype.step = function() {
      return SnakeBodyShadow.__super__.step.call(this);
    };

    return SnakeBodyShadow;
