...
(function() {
  var $, AppData, Art, Builder, Collision, Editor, EditorState, Entity, Game, Grid, Hero, ImageLoader, Keyboard, Level, Level2, LevelPrinter, Skull, Sprite, Text, World, _ref, _ref1,
  ...
  World = (function() {
    ...
    World.prototype.load_level = function(name) {
      var key, lvl, value, _ref, _results;
  ...
  Builder = (function() {
    ...
    Builder.prototype.editor_state = null;

    Builder.prototype.editor = null;

    function Builder(editor) {
      this.editor = editor;
      this.editor_state = new EditorState;
      this.world = Game.worlds[0];
    }

    Builder.prototype.save_level = function(name) {
      var e, i, lvl, o, _i, _len, _ref2, _results;
      i = 1;
      console.log(this.editor_state);
      console.log(this.editor_state.data);
      lvl = this.editor_state.data[name] = new Object();
    ...
    Builder.prototype.load_level = function(name) {
      var key, lvl, value, _ref2, _results;
      lvl = this.editor_state;
      _ref2 = lvl.data[name];
      _results = [];
      for (key in _ref2) {
        value = _ref2[key];
        _results.push(this.world.spawn(value.name, value.x, value.y));
      }
      return _results;
    };
  ...
  Editor = (function() {
    ...
    Editor.prototype.level_change = function() {
      ...
      return this.builder.load_level(this.level);
    };
