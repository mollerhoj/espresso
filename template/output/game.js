...
(function() {
  var $, AppData, Art, Collision, Editor, Entity, Game, Grid, Hero, ImageLoader, Keyboard, Level1, Sprite, Text, World, _ref,
  ...
  Sprite = (function() {
    ...
    Sprite.prototype.draw = function() {
      var image, x, y;
      x = this.x + Art.offset_x;
      y = this.y + Art.offset_y;
  ...
  Editor = (function() {
    ...
    Editor.prototype.toggle_pause = function() {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        _results.push(console.log(world.pause));
      }
      return _results;
    };
