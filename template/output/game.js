...
(function() {
  var $, AppData, Art, Collision, Entity, Game, Hero, ImageLoader, Keyboard, Level1, Sprite, Text, World, _ref,
  ...
  Game = (function() {
    ...
    Game.setup_editor = function() {
      var b;
      return b = $("#btn").click(Game.toggle_pause);
    };

    Game.toggle_pause = function() {
      var b, world, _i, _len, _ref, _results;
      b = $("#btn");
      if (Game.pause) {
        Game.pause = false;
        b.html('Pause');
